...
public class OrcActivity extends Activity {
	public static final String PACKAGE_NAME = "money.Tracker.presentation.activities";
	public static final String DATA_PATH = Environment
			.getExternalStorageDirectory().toString() + "/OrcActivity/";
	...
	private static final String TAG = "OrcActivity.java";
