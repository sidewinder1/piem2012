...
public class LendingLivingCost {
	...
	public LendingLivingCost(int _money, String _interestType, int _interest, String _startDate, String _expiredDate, String _name, String _address, String _phone)
	{
		this.money = _money;
