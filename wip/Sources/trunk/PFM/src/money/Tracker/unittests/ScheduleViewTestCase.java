...
public class ScheduleViewTestCase  extends AndroidTestCase {
	...
	public void testNumberOfSchedule() {
		...
		for(int i=0;i < 10;i++)
		{
			SqlHelper.instance.insert("Schedule", new String[] { "Budget",
					...
					String.valueOf(i * 10000), String.valueOf(i%2), "2012-10-" + i, "2012-11-" + (i + 20) });	
		}
	...
	public void testVerifyData() {
		...
		Cursor schedule = SqlHelper.instance.select("Schedule", "*", "Budget = 30000");
		...
		Assert.assertEquals("2012-10-3", schedule.getString(schedule.getColumnIndex("Start_date")));
		Assert.assertEquals("2012-11-23", schedule.getString(schedule.getColumnIndex("End_date")));
	}
}
