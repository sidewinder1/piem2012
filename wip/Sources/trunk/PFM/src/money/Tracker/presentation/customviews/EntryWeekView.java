...
public class EntryWeekView extends LinearLayout {
	...
	public EntryWeekView(Context context) {
		super(context);
	}
	...
	public EntryWeekView(Context context, String keyMonth,
		...
		layoutInflater.inflate(R.layout.entry_view_week_item, this, true);

		name = (TextView) findViewById(R.id.entry_view_week_item_name);
		cost = (TextView) findViewById(R.id.entry_view_week_item_cost);
		count_text = (TextView) findViewById(R.id.entry_view_week_count);
		chart = (LinearLayout) findViewById(R.id.entry_view_week_stacked_bar_chart);
