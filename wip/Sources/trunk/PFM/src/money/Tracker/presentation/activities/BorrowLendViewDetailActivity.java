...
public class BorrowLendViewDetailActivity extends Activity {
	...
	private void bindData() {
		...
		/*
		 * TextView personName = (TextView)
		 * findViewById(R.id.borrow_lend_detail_view_name); TextView personPhone
		 * = (TextView) findViewById(R.id.borrow_lend_detail_view_phone);
		 * TextView personAddress = (TextView)
		 * findViewById(R.id.borrow_lend_detail_view_address); TextView total =
		 * (TextView) findViewById(R.id.borrow_lend_detail_view_total); TextView
		 * interest = (TextView)
		 * findViewById(R.id.borrow_lend_detail_view_interest_rate); TextView
		 * interestType = (TextView)
		 * findViewById(R.id.borrow_lend_detail_view_interest_type); TextView
		 * startDate = (TextView)
		 * findViewById(R.id.borrow_lend_detail_view_start_date); TextView
		 * expriedDate = (TextView)
		 * findViewById(R.id.borrow_lend_detail_view_expired_date);
		 */
		 ...
		 * interest.setText(String.valueOf(values.getInterestRate())); if
		 * (String.valueOf(values.getInterestType()).equals("Simple"))
		 * interestType
		 * .setText(getResources().getString(R.string.simple_interest)); else
		 * interestType
		 * .setText(getResources().getString(R.string.compound_interest));
		 * Log.d("View Detail", String.valueOf(values.getStartDate()));
		 * startDate.setText(Converter.toString(values.getStartDate(),
		 * "dd/MM/yyyy")); Log.d("View Detail",
		 * String.valueOf(values.getExpiredDate())); if (values.getExpiredDate()
		 * != null) {
		 * expriedDate.setText(Converter.toString(values.getExpiredDate(),
		 * "dd/MM/yyyy")); } else { expriedDate.setText(""); }
		 */
		if (values.getDebtType().equals("Borrowing"))
			borrowLendDetailTitle.setText(getResources().getString(
					R.string.borrow_view_title));
		else
			borrowLendDetailTitle.setText(getResources().getString(
					R.string.lend_view_title));

		LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
				LayoutParams.FILL_PARENT, LayoutParams.WRAP_CONTENT);

		if (values.getDebtType().equals("Borrowing"))
			listViewDetail.addView(new BorrowLendViewDetailViewItem(this,
					getResources().getString(R.string.borrow_lend_lender),
					values.getPersonName()), params);
		else
			listViewDetail.addView(new BorrowLendViewDetailViewItem(this,
					getResources().getString(R.string.borrow_lend_borrower),
					values.getPersonName()), params);

		if (!values.getPersonPhone().equals(""))
			listViewDetail.addView(new BorrowLendViewDetailViewItem(this,
					getResources().getString(R.string.borrow_lend_phone),
					values.getPersonPhone()), params);

		if (!values.getPersonPhone().equals(""))
			listViewDetail.addView(new BorrowLendViewDetailViewItem(this,
					getResources().getString(R.string.borrow_lend_address),
					values.getPersonAddress()), params);

		// listViewDetail.addView(new BorrowLendViewDetailViewItem(this,
		// getResources().getString(R.string.borrow_lend_total_money),
		// Converter.toString(values.getMoney())), params);

		if (values.getInterestRate() != 0) {
			listViewDetail.addView(
					new BorrowLendViewDetailViewItem(this, getResources()
							.getString(R.string.borrow_lend_interest),
							new StringBuilder(String.valueOf(values
									.getInterestRate()))
									.append(" ")
									.append(getResources().getString(
											R.string.percent)).toString()),
					params);

			if (values.getInterestType().equals("Simple"))
				listViewDetail.addView(
						new BorrowLendViewDetailViewItem(this, getResources()
								.getString(R.string.borrow_lend_interest_type),
								getResources().getString(
										R.string.simple_interest)), params);
			else
				listViewDetail.addView(
						new BorrowLendViewDetailViewItem(this, getResources()
								.getString(R.string.borrow_lend_interest_type),
								getResources().getString(
										R.string.compound_interest)), params);
		}

		listViewDetail.addView(new BorrowLendViewDetailViewItem(this,
				getResources().getString(R.string.borrow_lend_start_date),
				Converter.toString(values.getStartDate(), "dd/MM/yyyy")),
				params);

		if (values.getExpiredDate() != null)
			listViewDetail.addView(new BorrowLendViewDetailViewItem(this,
					getResources().getString(R.string.borrow_lend_end_date),
					Converter.toString(values.getExpiredDate(), "dd/MM/yyyy")),
					params);
	...
	private void caculateInterest() {
		...
		if (values.getExpiredDate() != null) {
			...
			Log.d("Check caculate interest Date", leftDate + " - "
					+ caculateInterestDate);

			if (values.getInterestType().equals("Simple")) {
				Log.d("Check caculate interest Date", money + " - "
						+ interestRate + " - " + caculateInterestDate);
