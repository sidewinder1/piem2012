...
public class BorrowingLendingViewActivity extends TabActivity {
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent borrowViewIntent = new Intent(this, BorrowViewActivity.class);
		setupTab(borrowViewIntent, "Borrow", mTabHost);
		
		// Create tab and intent for Borrowing and Lending.
		Intent lendViewIntent = new Intent(this, LendViewActivity.class);
		...
		addBorrowLend.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent borrowLendInsert = new Intent(BorrowingLendingViewActivity.this, BorrowLendInsertActivity.class);
