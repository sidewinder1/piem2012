...
namespace PFMWebService
{
	...
	public partial class BorrowingLending : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _IsDelte;
    ...
    partial void OnIsDelteChanging(System.Nullable<int> value);
    partial void OnIsDelteChanged();
    ...
    partial void OnModifiedDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IsDelte", DbType="Int")]
		public System.Nullable<int> IsDelte
		{
			get
			{
				return this._IsDelte;
			}
			set
			{
				if ((this._IsDelte != value))
				{
					this.OnIsDelteChanging(value);
					this.SendPropertyChanging();
					this._IsDelte = value;
					this.SendPropertyChanged("IsDelte");
					this.OnIsDelteChanged();
				}
			}
		}
